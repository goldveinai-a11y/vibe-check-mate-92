...
- pop_culture_match: { couple, source, explanation }
  * Pull from this expanded US/UK Gen Z + Millennial pool (shows, movies, anime, and K-dramas — all internationally recognizable in English-speaking markets):
    ROMANTIC/DATING DYNAMICS: Euphoria, Normal People, Fleabag, Bridgerton, Friends, Sex and the City, After, Heartstopper, The Summer I Turned Pretty, Conversations With Friends, You, The White Lotus, How I Met Your Mother, New Girl, Emily in Paris, Gossip Girl, Never Have I Ever, Sex Education, Outer Banks, Riverdale, Schitt's Creek, Ted Lasso, Jane the Virgin, Crazy Ex-Girlfriend, Pretty Little Liars, La La Land, 500 Days of Summer, Love Actually, The Notebook, Call Me By Your Name, Challengers, Past Lives, 10 Things I Hate About You, To All the Boys I've Loved Before, Palm Springs, Someone Great, Set It Up, Anyone But You, It Ends With Us, Your Name, Toradora, Kaguya-sama: Love Is War, Horimiya, Fruits Basket, My Dress-Up Darling, Crash Landing on You, It's Okay to Not Be Okay, Business Proposal, True Beauty, Goblin.
    NON-ROMANTIC DYNAMICS (family, friend groups, toxic parents/siblings — use when the conversation ISN'T romantic): Gilmore Girls, Succession, Big Little Lies, This Is Us, Everything Everywhere All At Once, Turning Red, Lady Bird, Encanto, Modern Family, Squid Game, Attack on Titan, Demon Slayer.
  * Match the pool to the actual relationship type in the screenshots — don't force a romantic pairing onto a family/friend conversation or vice versa.
  * VARIETY RULE: do not default to the most generic/obvious fit (e.g. Friends, New Girl) just because it's safe — actively consider at least 2-3 candidates from the pool and pick whichever has the sharpest, most specific behavioral overlap, even if it's a less common pick from the list. Rotate across shows, movies, anime, and K-dramas — do not let TV dominate every result.
  * couple = "Name & Name (specific era or arc)", e.g. "Ross & Rachel (post-break era)", "Rue & Jules (season 1)". For non-couple pairs (parent/child, siblings, friends) use the actual relationship, e.g. "Lorelai & Emily (early seasons)".
...
type Report = {
  ...
  hardcore_analytics: {
    ...
    your_voice_style: string;       // the UPLOADER's ("you") own writing-style fingerprint, e.g. "Short, direct sentences. Rarely uses emoji. Dry, understated humor. Initiates topics but keeps replies brief." Structural only, never a quote.
  };
